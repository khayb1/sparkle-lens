...
import {AboutBg, Avatar} from "../index";
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start p-10 pb-24">
        ...
        <div className="flex-1 md:w-1/2 mt-4 md:mt-0 md:ml-8 text-justify ">
          ...
          <p className="mb-4 font-light text-lg ">
            I'm a photographer with over 10 years of experience in capturing
            life's precious moments. I specialize in creating images that are
            both visually striking and emotionally impactful, and I have
            developed a signature style that blends natural beauty with vibrant
          ...
          <p className="mb-4 font-light text-lg">
            ...
            more of my gallery, please don't hesitate to get in touch. Let's
