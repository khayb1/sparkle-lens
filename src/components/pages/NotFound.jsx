...
export const NotFound = () => {
  return (
    <div><div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white relative">
    {/* Background Image */}
    <div
   ...
   ></div>
    ...
    <div className="relative z-10 text-center">
      ...
      <p className="text-2xl mb-6">Oops! The page you're looking for is out of focus.</p>
