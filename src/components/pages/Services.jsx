...
import { ServiceGif } from '../index'

export const Services = () => {
  return (
    <>
      <NewHeader
        backgroundImage={ServiceGif}
        header="SERVICES"
      ...
      <div className="p-10 md:px-10 lg:px-20 bg-blue-200">
        <h3 className="text-2xl md:text-3xl text-blue-700 mb-4 font-light">
          Pricing{" "}
        </h3>
        ...
        <div className="flex flex-wrap">
          <Pricing text="Portrait Photography" price="ghc 200" />

          <Pricing text="Videography" price="ghc 500" />

          <Pricing text="Editing and Post-Production:" price="ghc 300" />

          <Pricing text="Picture Frame:" price="ghc 150" />
        </div>
      </div>
      <Testimonials />
    </>
